	...
	<div class="banner_inner d-flex align-items-center">
		...
		<div class="container">
			<div class="banner_content text-center">
				<h3 data-aos="fade-up" data-aos-duration="1600">Belajar Dimana Saja & Kapan Saja <br /> Mudah Dengan Si-Pandai</h3>
				<p data-aos="fade-up" data-aos-duration="1900">Dengan Si-Pandai kemudahan kegiatan belajar mengajar dapat terpenuhi. Para guru dan siswa dapat
					belajar meski banyak halangan atau rintangan. Nikmati Pembelajaran terstruktur dan efektif menggunakan Si-Pandai serta kemudahan belajar dengan menggunakan aplikasi kami. </p>
		...
		<div class="row">
			<div class="col-md-7 mx-auto">
				<div class="main_title">
					<h2 data-aos="fade-up" data-aos-duration="2000">Si-Pandai Dibuat Untuk Meningkatkan Kualitas Pembelajaran Di Indonesia</h2>
					<p data-aos="fade-up" data-aos-duration="2200">Dengan Si-Pandai diharapkan siswa/siswi generasi sekarang lebih mudah dan lebih tertarik untuk belajar dimana saja dan kapan saja</p>
					<a href="https://github.com/syauqi/learnify"><button data-aos="fade-up" data-aos-duration="2400" class="bubbly-button">Download Si-Pandai <span class="lnr lnr-arrow-right"></span></button></a>
				</div>
			</div>
		</div>
	</div>
						...
						<div class="courses_item" data-aos="fade-right" data-aos-duration="1800">
							...
							<div class="hover_text">
								...
								<ul class="list">
									...
									<li><a href="#"><i class="lnr lnr-user"></i>Guru Matematika Si-Pandai</a>
									</li>
								</ul>
							</div>
						</div>
						...
						<div class="courses_item" data-aos="fade-down" data-aos-duration="1800">
							...
							<div class="hover_text">
								...
								<ul class="list">
									...
									<li><a href="#"><i class="lnr lnr-bubble"></i> 0</a></li>
									<li><a href="#"><i class="lnr lnr-user"></i> Guru IPA Si-Pandai</a></li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="courses_item" data-aos="fade-right" data-aos-duration="1800">
							...
							<div class="hover_text">
								...
								<ul class="list">
									...
									<li><a href="#"><i class="lnr lnr-bubble"></i> 0</a></li>
									<li><a href="#"><i class="lnr lnr-user"></i> Guru English Si-Pandai</a></li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="courses_item" data-aos="fade-up" data-aos-duration="1800">
							...
							<div class="hover_text">
								...
								<ul class="list">
									...
									<li><a href="#"><i class="lnr lnr-bubble"></i> 0</a></li>
									<li><a href="#"><i class="lnr lnr-user"></i> Guru Indonesia Si-Pandai</a>
									</li>
								</ul>
							</div>
						</div>
				...
				<div class="course_item" data-aos="fade-left" data-aos-duration="1800">
					...
					<div class="hover_text">
						...
						<ul class="list">
							...
							<li><a href="#"><i class="lnr lnr-bubble"></i> 0</a></li>
							<li><a href="#"><i class="lnr lnr-user"></i> Guru Agama Si-Pandai</a></li>
						</ul>
					</div>
				</div>
			</div>
...
<section class="team_area p_20">
	<div class="container">
		<div class="main_title">
			<h2 data-aos="fade-up" data-aos-duration="1800">Testimonial Para Siswa Si-Pandai</h2>
