    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                ...
                <p>
                    Web Edukasi Open Source yang dibuat oleh Herman Dan Team. Si-Pandai adalah Web edukasi yang dilengkapi video, materi dan sistem ujian yang tersedia secara gratis. Si-Pandai dibuat ditujukan agar para siswa dan guru dapat terus belajar dan mengajar dimana saja dan kapan saja.
                </p>
            </div>
        </div>
